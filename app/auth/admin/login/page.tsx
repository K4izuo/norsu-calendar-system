...
export default function AdminLoginPage() {
  ...
  return (
    <div className="min-h-[100dvh] w-full bg-gradient-to-br from-gray-900 to-gray-800 flex items-center justify-center py-6 px-3 sm:px-4 lg:px-6 relative overflow-hidden">
      ...
      <div className="absolute top-0 left-0 w-48 h-48 bg-gray-600 rounded-full opacity-20 -translate-x-24 -translate-y-24"></div>
      <div className="absolute top-0 right-0 w-48 h-48 bg-gray-500 rounded-full opacity-10 translate-x-24 -translate-y-24"></div>
      <div className="absolute bottom-0 right-0 w-48 h-48 bg-gray-500 rounded-full opacity-20 translate-x-24 translate-y-24"></div>
      <div className="absolute bottom-0 left-0 w-48 h-48 bg-gray-600 rounded-full opacity-20 -translate-x-24 translate-y-24"></div>
