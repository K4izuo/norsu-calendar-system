  ...
  return (
    <div className="h-screen w-screen bg-gradient-to-br from-gray-900 to-gray-800 font-['Poppins'] flex items-center justify-center p-2 sm:p-4 lg:p-6 relative overflow-hidden">
      ...
      <motion.div
        ...
        className="bg-gray-800 rounded-xl sm:rounded-2xl shadow-2xl overflow-hidden w-[96%] max-w-4xl grid grid-cols-1 md:grid-cols-2 relative p-2 sm:p-0 border border-gray-700"
      >
