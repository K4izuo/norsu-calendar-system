...
import { GraduationCap, BookOpen, Users, Award, Calendar } from "lucide-react"
...
export default function StudentLoginPage() {
  ...
  return (
    <div className="min-h-[100dvh] w-full bg-gradient-to-br from-green-50 to-emerald-50 flex items-center justify-center py-6 px-2.5 sm:px-4 lg:px-6 relative overflow-hidden">
      ...
      <div className="absolute top-0 left-0 w-48 h-48 bg-green-600 rounded-full opacity-20 -translate-x-24 -translate-y-24"></div>
      <div className="absolute top-0 right-0 w-48 h-48 bg-green-600 rounded-full opacity-10 translate-x-24 -translate-y-24"></div>
      <div className="absolute bottom-0 right-0 w-48 h-48 bg-green-500 rounded-full opacity-20 translate-x-24 translate-y-24"></div>
      <div className="absolute bottom-0 left-0 w-48 h-48 bg-green-600 rounded-full opacity-20 -translate-x-24 translate-y-24"></div>
      ...
      >
        ...
        <div className="hidden md:flex bg-gradient-to-br from-green-600 to-emerald-700 p-4 sm:p-6 lg:p-8 text-white flex-col items-center justify-center relative min-h-[400px]">
          ...
          <div className="space-y-6 text-center z-10 flex flex-col items-center justify-center h-full">
            {/* Logo/Icon with Student branding */}
            ...
            <div className="space-y-3">
              <h2 className="text-2xl sm:text-3xl font-bold">NORSU Portal</h2>
              <p className="text-green-100 text-lg">Student Access System</p>
              <p className="text-green-200 text-sm max-w-xs">
                Access your courses, grades, schedules and connect with your academic community
              </p>
            </div>
