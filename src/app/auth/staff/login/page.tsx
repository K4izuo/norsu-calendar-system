...
export default function StaffLoginPage() {
  ...
  return (
    <div className="min-h-dvh w-full bg-linear-to-br from-purple-50 to-purple-100 font-['Poppins'] flex items-center justify-center py-6 px-3 sm:px-4 lg:px-6 relative overflow-hidden">
      ...
      >
        {/* Left Side */}
        <div className="hidden md:flex bg-linear-to-br from-purple-400 to-purple-600 p-4 sm:p-6 lg:p-8 text-white flex-col items-center justify-center relative min-h-95">
