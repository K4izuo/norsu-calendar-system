...
export default function AboutSection1() {
  ...
  return (
    <section
      className="relative py-12 pb-20 px-4 bg-gray-50 overflow-x-hidden overflow-y-auto"
      ref={heroRef}
    >
      <svg className="absolute -top-249.75 -left-249.75 w-0 h-0">
        <defs>
      ...
      />
      <TimelineContent
        className="absolute bottom-0 left-0 right-0 top-0 bg-[linear-gradient(to_right,#a3a3a32e_1px,transparent_1px),linear-gradient(to_bottom,#a3a3a32e_1px,transparent_1px)] bg-size-[70px_70px] mask-[radial-gradient(ellipse_80%_50%_at_50%_100%,#000_70%,transparent_110%)]"
        animationNum={3}
        customVariants={revealVariants3}
        timelineRef={heroRef}
      />
      ...
      <div className="relative z-10 max-w-2xl mx-auto">
        <div className="text-gray-800 text-4xl font-semibold text-center mb-2">
          About
        </div>
        <div className="w-24 h-1 bg-linear-to-r bg-gray-800 mx-auto rounded-full"></div>
      </div>
      <div className="max-w-4xl mx-auto pt-16 pb-8">
        <div className="grid grid-cols-3 gap-8 lg:h-104 md:h-88 sm:h-64 h-56 mb-6 items-center">
          {/* First Image */}
          <TimelineContent
            as="figure"
            animationNum={4}
        ...
        <div className="grid grid-cols-3 gap-8 items-start">
          ...
          >
            <h3 className="text-gray-900 text-xl font-semibold">
              Cris Justine Oracion
            </h3>
            <p className="text-gray-600 text-sm mt-1">Lead Developer</p>
          </TimelineContent>
          ...
          >
            ...
            <p className="text-gray-600 text-sm mt-1">Assistant Researcher</p>
          </TimelineContent>
          ...
          >
            ...
            <p className="text-gray-600 text-sm mt-1">Documentary & Researcher</p>
          </TimelineContent>
        </div>
        ...
        >
          <Link
            href="/"
            className="inline-flex items-center gap-2 px-4 py-2 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-lg hover:bg-gray-50 hover:text-gray-900 transition-colors duration-200 shadow-sm"
          >
