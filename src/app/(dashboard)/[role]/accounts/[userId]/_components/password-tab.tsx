          ...
          <div className="flex flex-col gap-1.5">
            ...
            <div className="relative">
              <Input
                ...
                className={errors.new_password ? "border-red-500 focus-visible:ring-red-200 focus-visible:border-red-500 h-12 pr-10" : "pr-10 h-12 border-gray-300 focus:border-blue-500 focus:ring-blue-500/20 transition-all duration-150"}
              />
              <button
                type="button"
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <div className="relative">
              <Input
                ...
                className={errors.confirm_password ? "border-red-500 focus-visible:ring-red-200 focus-visible:border-red-500 h-12 pr-10" : "pr-10 h-12 border-gray-300 focus:border-blue-500 focus:ring-blue-500/20 transition-all duration-150"}
              />
              <button
                type="button"
