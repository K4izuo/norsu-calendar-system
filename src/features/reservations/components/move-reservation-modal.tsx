...
export const MoveReservationModal: React.FC<MoveReservationModalProps> = ({
  ...
  const fieldInputClassName =
    "move-picker-input mt-1 h-12 cursor-pointer border rounded-lg border-gray-300 pr-12 text-base transition-all duration-150 focus:border-blue-500 focus:ring-blue-500/20";
          ...
          >
            ...
            <div className="flex gap-3 pt-1">
              ...
              <Button
                ...
                className="flex-1 cursor-pointer bg-blue-500 hover:bg-blue-600 text-white disabled:opacity-50 disabled:cursor-not-allowed"
              >
                {isPending ? (
                  <>
