...
export const FIELD_LABELS: Record<keyof StaffRegisterFormData, string> = {
...
export const REQUIRED_FIELDS: Array<keyof StaffRegisterFormData> = [
  "first_name",
  "middle_name",
  "last_name",
  "email",
...
export function showFieldErrorToast(
  errors: FieldErrors<StaffRegisterFormData>,
  values: StaffRegisterFormData
) {
  ...
  const errorKeys = Object.keys(errors) as Array<keyof StaffRegisterFormData>;
